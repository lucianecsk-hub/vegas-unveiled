...
const PAID = [
  ...
  { id:61, name:"Four Seasons Spa Day", cat:"Wellness", price:150, rating:4.9, reviews:50, dur:"Full day", emoji:"💆", desc:"Forbes 5-star. Mineral pools, expert therapists, complete silence. The reset Vegas can actually give you.", url:"https://vegas.vdvm.net/JkL7PE", provider:"VCO", tags:["couple","solo","girls","wellness"], vibes:["luxury","romantic"], times:["morning","day","allday"], seasons:["spring","summer","fall","winter"], interests:["wellness","unique"], tier:"premium", girlsTrip:true },
  { id:62, name:"Canyon Ranch Spa — Venetian", cat:"Wellness", price:120, rating:4.8, reviews:200, dur:"Half day", emoji:"🧖", desc:"The world's most famous spa brand, inside The Venetian. Massages, fitness, complete transformation.", url:"https://vegas.vdvm.net/xJ2YMv", provider:"VCO", tags:["couple","solo","bachelorette","girls","wellness"], vibes:["luxury","romantic"], times:["morning","day","allday"], seasons:["spring","summer","fall","winter"], interests:["wellness","unique"], tier:"premium", girlsTrip:true },
  { id:63, name:"The Spa at Encore — Wynn", cat:"Wellness", price:130, rating:4.9, reviews:150, dur:"Half day", emoji:"🌿", desc:"One of the most awarded spas in North America. Inside Encore at Wynn. Pure luxury, no casino noise.", url:"https://vegas.vdvm.net/dy9YMk", provider:"VCO", tags:["couple","solo","girls","wellness"], vibes:["luxury","romantic"], times:["morning","day","allday"], seasons:["spring","summer","fall","winter"], interests:["wellness","unique"], tier:"premium", girlsTrip:true },
  { id:64, name:"Vdara Spa & Salon", cat:"Wellness", price:80, rating:4.7, reviews:100, dur:"Half day", emoji:"🛁", desc:"No casino. No noise. Just a world-class spa in the most peaceful hotel on the Strip.", url:"https://vegas.vdvm.net/6kPmjG", provider:"VCO", tags:["solo","work","wellness"], vibes:["luxury"], times:["morning","day","allday"], seasons:["spring","summer","fall","winter"], interests:["wellness","unique"], tier:"mid" },
  { id:65, name:"Nelson Ghost Town & Mine Tour", cat:"Dark", price:134, rating:4.7, reviews:68, dur:"4 hrs", emoji:"👻", desc:"An abandoned 1800s gold mining town 45 minutes from Vegas. Rusty cars, real ghost stories, an actual mine. The dark side Nevada doesn't advertise.", url:"https://www.getyourguide.com/nelson-ghost-town-nevada-l187538/las-vegas-nelson-ghost-town-with-mine-tour-option-t1221627/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["couple","group","solo"], vibes:["dark","adventure","unique"], times:["morning","day"], seasons:["spring","fall","winter"], interests:["unique","adventure"], tier:"mid" },
  { id:74, name:"Strip Club Crawl + Open Bar + Party Bus", cat:"Nightlife", price:99, rating:4.7, reviews:150, dur:"4 hrs", emoji:"🎪", desc:"Party bus, open bar and VIP entry to Vegas' top strip clubs. The bachelor party night this city was built for.", url:"https://www.getyourguide.com/las-vegas-l58/strip-club-crawl-open-bar-party-bus-t442598/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["group","bachelorette","guys","solo"], vibes:["dark","unique"], times:["night","allday"], seasons:["spring","summer","fall","winter"], interests:["nightlife"], tier:"mid", guysTrip:true },
  { id:66, name:"Pool Party Crawl by Party Bus", cat:"Nightlife", price:99, rating:4.5, reviews:110, dur:"5 hrs", emoji:"🏊", desc:"Party bus to a Vegas pool party with free drinks and VIP entry. The definitive Vegas summer experience.", url:"https://www.getyourguide.com/las-vegas-l58/las-vegas-pool-party-crawl-by-party-bus-t439815/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["group","bachelorette","girls","solo"], vibes:["adventure","unique"], times:["day","allday"], seasons:["summer"], interests:["nightlife"], tier:"mid", girlsTrip:true },
  ...
  // ── LGBT EXPERIENCES ──
  { id:68, name:"EDC Las Vegas 2026", cat:"Festival", price:350, rating:4.9, reviews:500, dur:"3 nights", emoji:"🎡", desc:"Electric Daisy Carnival — the world's most iconic EDM festival. Las Vegas Motor Speedway. Three nights of pure freedom.", url:"https://vegas.vdvm.net/L0xvKL", provider:"VCO", tags:["group","solo","lgbtq"], vibes:["adventure","unique"], times:["night","allday"], seasons:["spring"], interests:["show","nightlife"], tier:"luxury", lgbtq:true },
  { id:69, name:"Phoenix Bar and Lounge", cat:"Nightlife", price:20, rating:4.8, reviews:200, dur:"Night", emoji:"🌈", desc:"Vegas' most welcoming LGBT bar. No attitude, all energy. The kind of place you don't want to leave.", url:"https://vegas.vdvm.net/5kMey2", provider:"VCO", tags:["group","solo","couple","lgbtq"], vibes:["unique"], times:["night","allday"], seasons:["spring","summer","fall","winter"], interests:["nightlife"], tier:"budget", lgbtq:true },
  { id:70, name:"Faaabulous! Ultimate Drag Brunch", cat:"Show", price:75, rating:4.9, reviews:150, dur:"2 hrs", emoji:"👑", desc:"The most spectacular drag brunch in Vegas. Lip sync battles, comedy, audience moments. Saturday mornings at their most fabulous.", url:"https://vegas.vdvm.net/Gb06Em", provider:"VCO", tags:["group","couple","solo","bachelorette","lgbtq","girls"], vibes:["unique"], times:["morning","day"], seasons:["spring","summer","fall","winter"], interests:["show"], tier:"mid", lgbtq:true },
  { id:71, name:"Drag Brunch Las Vegas", cat:"Show", price:65, rating:4.8, reviews:120, dur:"2 hrs", emoji:"💅", desc:"Bottomless mimosas, drag queens, and the most fun brunch you've ever had. Reservations essential.", url:"https://vegas.vdvm.net/n4ROgA", provider:"VCO", tags:["group","couple","solo","lgbtq","girls"], vibes:["unique"], times:["morning","day"], seasons:["spring","summer","fall","winter"], interests:["show"], tier:"mid", lgbtq:true },
  { id:72, name:"RuPaul's Drag Race LIVE!", cat:"Show", price:99, rating:4.9, reviews:800, dur:"1.5 hrs", emoji:"🏆", desc:"The queens from RuPaul's Drag Race, live on the Vegas Strip. Iconic. Unmissable. The most entertaining show in town.", url:"https://vegas.vdvm.net/QYNqGY", provider:"VCO", tags:["group","couple","solo","lgbtq","girls","bachelorette"], vibes:["luxury","unique"], times:["night","allday"], seasons:["spring","summer","fall","winter"], interests:["show"], tier:"mid", lgbtq:true },
  { id:73, name:"Drag Your Sass to Brunch — Hamburger Mary's", cat:"Show", price:55, rating:4.8, reviews:90, dur:"2 hrs", emoji:"🍔", desc:"Hamburger Mary's legendary drag brunch. Outrageous, hilarious, and inclusive. The most fun $55 you'll spend in Vegas.", url:"https://vegas.vdvm.net/B5zWG9", provider:"VCO", tags:["group","couple","solo","lgbtq","girls"], vibes:["unique"], times:["morning","day"], seasons:["spring","summer","fall","winter"], interests:["show"], tier:"budget", lgbtq:true },
  // ── SPORTS ──
  { id:75, name:"Circa Las Vegas Sportsbook", cat:"Sports", price:0, rating:4.9, reviews:300, dur:"Any time", emoji:"🏆", desc:"The largest sportsbook in the world. 4 stories, 350 screens, stadium seating. Watch any game like nowhere else on Earth.", url:"https://vegas.vdvm.net/jRnEoP", provider:"VCO", tags:["guys","group","solo","work","couple"], vibes:["casino","unique"], times:["day","night","allday"], seasons:["spring","summer","fall","winter"], interests:["sports","unique"], tier:"budget", guysTrip:true },
  { id:76, name:"MGM Grand Race & Sports Book", cat:"Sports", price:0, rating:4.7, reviews:200, dur:"Any time", emoji:"🎰", desc:"One of Vegas' most iconic sportsbooks. Inside MGM Grand. Great screens, great action, great atmosphere.", url:"https://vegas.vdvm.net/vD4LLv", provider:"VCO", tags:["guys","group","solo","work"], vibes:["casino","unique"], times:["day","night","allday"], seasons:["spring","summer","fall","winter"], interests:["sports","unique"], tier:"budget", guysTrip:true },
  { id:77, name:"Vegas Golden Knights — NHL Game", cat:"Sports", price:80, rating:4.9, reviews:500, dur:"3 hrs", emoji:"🏒", desc:"T-Mobile Arena. The team that made Vegas a real sports city. The most electric atmosphere in the NHL.", url:"https://vegas.vdvm.net/YVq55P", provider:"VCO", tags:["guys","group","solo","work","couple","family"], vibes:["adventure","unique"], times:["night","allday"], seasons:["winter","spring","fall"], interests:["sports"], tier:"mid", guysTrip:true },
  { id:78, name:"Las Vegas Aces — WNBA Game", cat:"Sports", price:40, rating:4.8, reviews:200, dur:"2.5 hrs", emoji:"🏀", desc:"Back-to-back WNBA champions. Michelob Ultra Arena. The most exciting women's basketball in the world.", url:"https://vegas.vdvm.net/xJ2xx1", provider:"VCO", tags:["girls","group","couple","family","solo"], vibes:["unique"], times:["night","day","allday"], seasons:["summer","spring"], interests:["sports"], tier:"budget", girlsTrip:true },
  { id:79, name:"Las Vegas Aviators — Baseball Game", cat:"Sports", price:20, rating:4.7, reviews:150, dur:"3 hrs", emoji:"⚾", desc:"Triple-A baseball at Las Vegas Ballpark. Affordable, fun for all ages. The best family sports experience in Vegas.", url:"https://vegas.vdvm.net/PzrLLe", provider:"VCO", tags:["family","group","solo","couple","kids"], vibes:["unique"], times:["night","day","allday"], seasons:["spring","summer","fall"], interests:["sports"], tier:"budget" },
  { id:80, name:"Henderson Silver Knights — Hockey", cat:"Sports", price:25, rating:4.7, reviews:100, dur:"2.5 hrs", emoji:"🥅", desc:"The VGK's farm team. Dollar Arena in Henderson. Great hockey, small venue, affordable — the locals' choice.", url:"https://vegas.vdvm.net/L0xvJM", provider:"VCO", tags:["family","group","guys","solo","kids"], vibes:["unique"], times:["night","allday"], seasons:["winter","spring","fall"], interests:["sports"], tier:"budget", guysTrip:true },
  // ── LIMITED TIME ──
  { id:81, name:"Dolly Parton Live at Allegiant Stadium", cat:"Concert", price:1843, rating:4.9, reviews:100, dur:"2.5 hrs", emoji:"🎸", desc:"The Queen of Country. Live at Allegiant Stadium. September shows only — premium event, limited seats.", url:"https://vegas.vdvm.net/gRAzj9", provider:"VCO", tags:["couple","solo","group","girls","work"], vibes:["unique","romantic","luxury"], times:["night","allday"], seasons:["fall"], interests:["show"], tier:"luxury", girlsTrip:true, limitedTime:"Until Sep 26, 2026" },
  { id:82, name:"NHRA Nationals Las Vegas", cat:"Sports", price:45, rating:4.8, reviews:80, dur:"Full day", emoji:"🚗", desc:"The fastest cars on the planet. The loudest event in Vegas. NHRA drag racing at its absolute best.", url:"https://vegas.vdvm.net/enrDn1", provider:"VCO", tags:["guys","group","solo","family"], vibes:["adventure","unique"], times:["morning","day","allday"], seasons:["fall"], interests:["sports","adventure"], tier:"budget", guysTrip:true, limitedTime:"Until Nov 1" },
  { id:83, name:"NBA Summer League", cat:"Sports", price:30, rating:4.7, reviews:150, dur:"2.5 hrs", emoji:"🏀", desc:"Watch NBA rookies and future stars before they make it big. Thomas & Mack Center. Vegas summers just got better.", url:"https://vegas.vdvm.net/B5zj5B", provider:"VCO", tags:["guys","group","solo","couple","family"], vibes:["unique"], times:["day","night","allday"], seasons:["summer"], interests:["sports"], tier:"budget", limitedTime:"Until Jul 19" },
  { id:84, name:"NASCAR Cup Series Las Vegas", cat:"Sports", price:75, rating:4.8, reviews:200, dur:"Full day", emoji:"🏁", desc:"500 miles of pure adrenaline at Las Vegas Motor Speedway. The loudest Sunday you'll ever have.", url:"https://vegas.vdvm.net/6kPvkQ", provider:"VCO", tags:["guys","group","solo","family"], vibes:["adventure","unique"], times:["morning","day","allday"], seasons:["fall"], interests:["sports","adventure"], tier:"mid", guysTrip:true, limitedTime:"Until Oct 4" },
  { id:85, name:"Formula 1 Las Vegas Grand Prix", cat:"Sports", price:500, rating:4.9, reviews:300, dur:"Full day", emoji:"🏎️", desc:"F1 racing on the Las Vegas Strip at night. The most spectacular sporting event in the world — right here.", url:"https://vegas.vdvm.net/dy9xyW", provider:"VCO", tags:["guys","group","couple","work","solo"], vibes:["luxury","adventure","unique"], times:["night","allday"], seasons:["fall"], interests:["sports","adventure"], tier:"luxury", guysTrip:true, limitedTime:"Until Nov 21" },
  { id:86, name:"BTS — Live in Las Vegas", cat:"Concert", price:101, rating:4.9, reviews:200, dur:"2.5 hrs", emoji:"💜", desc:"BTS live at Allegiant Stadium. Shows May 23, 24, 27 & 28. The biggest K-pop event of the year — don't miss it.", url:"https://vegas.vdvm.net/m4XeGa", provider:"VCO", tags:["girls","group","couple","solo","lgbtq"], vibes:["luxury","unique"], times:["night","allday"], seasons:["spring"], interests:["show"], tier:"mid", girlsTrip:true, lgbtq:true, limitedTime:"May 23–28, 2026" },
  { id:87, name:"Cowabunga Canyon Water Park", cat:"Adventure", price:45, rating:4.7, reviews:300, dur:"Full day", emoji:"💦", desc:"Vegas' best water park. Slides, lazy river, wave pool — the perfect summer day with kids of all ages.", url:"https://vegas.vdvm.net/xkWeD1", provider:"VCO", tags:["family","kids","group","solo"], vibes:["adventure"], times:["morning","day","allday"], seasons:["summer"], interests:["adventure","unique"], tier:"budget" },
];
...
const HOTELS = [
  // LUXURY 5★
  { name:"Wynn Las Vegas", stars:5, price:"$250–$600/night", feature:"Best spa & pool on Strip", url:"https://vegas.vdvm.net/n4RmL9", profiles:["luxury","couple","girls","first-timer","work"], nosmoking:false, kitchen:false },
  { name:"Bellagio", stars:5, price:"$200–$500/night", feature:"Iconic fountains, fine dining", url:"https://vegas.vdvm.net/OY9Per", profiles:["luxury","couple","first-timer","work"], nosmoking:false, kitchen:false },
  { name:"The Venetian Resort", stars:5, price:"$200–$450/night", feature:"Gondola rides, huge suites", url:"https://vegas.vdvm.net/y200Jv", profiles:["luxury","couple","girls","first-timer"], nosmoking:false, kitchen:false },
  { name:"Cosmopolitan", stars:5, price:"$180–$500/night", feature:"Hippest hotel, best vibe", url:"https://vegas.vdvm.net/POPzZX", profiles:["luxury","couple","girls","first-timer"], nosmoking:false, kitchen:false },
  { name:"Caesars Palace", stars:5, price:"$150–$400/night", feature:"Most iconic Vegas hotel", url:"https://vegas.vdvm.net/QYNkjx", profiles:["luxury","couple","first-timer","work"], nosmoking:false, kitchen:false },
  { name:"Fontainebleau Las Vegas", stars:5, price:"$200–$600/night", feature:"Newest 5-star, stunning design", url:"https://vegas.vdvm.net/5kM4k3", profiles:["luxury","couple","girls","work"], nosmoking:false, kitchen:false },
  { name:"Trump International Hotel", stars:5, price:"$150–$400/night", feature:"No casino, suites with mini kitchen", url:"https://vegas.vdvm.net/GmzdA6", profiles:["luxury","couple","family","work"], nosmoking:true, kitchen:true },
  { name:"Aria Resort & Casino", stars:5, price:"$180–$450/night", feature:"Modern luxury, best casino tech", url:"https://vegas.vdvm.net/MKDrA2", profiles:["luxury","work"], nosmoking:false, kitchen:false },
  // MID 4★
  { name:"MGM Grand", stars:4, price:"$100–$300/night", feature:"Huge casino, great pools", url:"https://vegas.vdvm.net/DWb4Lo", profiles:["first-timer","work"], nosmoking:false, kitchen:false },
  { name:"Mandalay Bay", stars:4, price:"$120–$350/night", feature:"Beach pool, lazy river — best for families", url:"https://vegas.vdvm.net/WqmQxO", profiles:["couple","girls","family"], nosmoking:false, kitchen:false },
  { name:"The Signature at MGM Grand", stars:4, price:"$120–$350/night", feature:"All suites, separate entrance, no casino noise", url:"https://vegas.vdvm.net/rQ6o4d", profiles:["family","couple","work"], nosmoking:true, kitchen:true },
  { name:"Hilton Grand Vacations Club Elara", stars:4, price:"$130–$300/night", feature:"Suite with full kitchen, Center Strip", url:"https://vegas.vdvm.net/PzrobX", profiles:["family","couple"], nosmoking:true, kitchen:true },
  { name:"Park MGM", stars:4, price:"$80–$200/night", feature:"Only 100% smoke-free casino on Strip", url:"https://vegas.vdvm.net/L0x90L", profiles:["couple","first-timer","work"], nosmoking:true, kitchen:false },
  { name:"Vdara Hotel & Spa", stars:4, price:"$100–$250/night", feature:"No casino, suites with kitchen, quiet", url:"https://vegas.vdvm.net/xk4DEx", profiles:["couple","work","family"], nosmoking:true, kitchen:true },
  { name:"SAHARA Las Vegas", stars:4, price:"$70–$180/night", feature:"Great pool, energetic vibe, North Strip", url:"https://vegas.vdvm.net/E0z4qe", profiles:["bachelorette","first-timer"], nosmoking:false, kitchen:false },
  // MID 3★
  { name:"The LINQ Hotel", stars:3, price:"$60–$150/night", feature:"Steps from High Roller", url:"https://vegas.vdvm.net/Gb0Lbr", profiles:["couple","girls","first-timer"], nosmoking:false, kitchen:false },
  { name:"Paris Las Vegas", stars:4, price:"$80–$200/night", feature:"Eiffel Tower views, romantic", url:"https://vegas.vdvm.net/xJ21JR", profiles:["couple","girls","first-timer"], nosmoking:false, kitchen:false },
  { name:"Flamingo Las Vegas", stars:3, price:"$50–$130/night", feature:"Wildlife habitat, classic Vegas", url:"https://vegas.vdvm.net/1GD49x", profiles:["couple","girls","first-timer"], nosmoking:false, kitchen:false },
  { name:"Jockey Club", stars:3, price:"$80–$180/night", feature:"Suite with kitchen, steps from Bellagio", url:"https://vegas.vdvm.net/m5WVRy", profiles:["family","couple"], nosmoking:true, kitchen:true },
  { name:"Horseshoe Las Vegas", stars:3, price:"$50–$120/night", feature:"Central location, great value", url:"https://vegas.vdvm.net/Pzr5aX", profiles:["first-timer","work"], nosmoking:false, kitchen:false },
  { name:"New York-New York", stars:3, price:"$60–$150/night", feature:"Roller coaster, fun atmosphere", url:"https://vegas.vdvm.net/aNxEKb", profiles:["family","first-timer"], nosmoking:false, kitchen:false },
];
...
function filterExperiences(ans) {
  ...
  const scored = PAID.map(exp => {
    ...
    if(ans.timeOfDay!=="allday" && !exp.times.includes(ans.timeOfDay) && !exp.times.includes("allday")) s-=3;
    return {...exp,score:s};
  ...
  const dayScored = scored.filter(e=>
    (e.times.includes("morning")||e.times.includes("day")||e.times.includes("allday")) &&
    budgetMatch(e.price)
  );
  const nightScored = scored.filter(e=>
    (e.times.includes("night")||e.times.includes("allday")) &&
    budgetMatch(e.price)
  );

  // Build pairs: alternating day/night
  let dayIdx=0, nightIdx=0;
  for(let i=0; i<dayPairs; i++){
    // Add day experience
    while(dayIdx<dayScored.length && used.has(dayScored[dayIdx].id)) dayIdx++;
    if(dayIdx<dayScored.length){ used.add(dayScored[dayIdx].id); result.push({...dayScored[dayIdx], timeSlot:"day"}); dayIdx++; }
    // Add night experience
    while(nightIdx<nightScored.length && used.has(nightScored[nightIdx].id)) nightIdx++;
    if(nightIdx<nightScored.length){ used.add(nightScored[nightIdx].id); result.push({...nightScored[nightIdx], timeSlot:"night"}); nightIdx++; }
  }
...
function getHotels(ans) {
  const profile = [];
  const budgetLimit = {budget:100, mid:150, high:300, vip:999}[ans.budget] || 300;
  ...
  if((ans.vibe==="luxury" || ans.hotelPref==="luxury") && ans.budget!=="budget" && ans.budget!=="mid") profile.push("luxury");
  if(ans.tripType==="couple") profile.push("couple");
  ...
  if(ans.vibe==="first-timer" || ans.hotelPref==="location") profile.push("first-timer");
  if(ans.hotelPref==="nosmoking") profile.push("couple","work","family");
  if(ans.hotelPref==="price" || ans.budget==="budget") profile.push("first-timer");
  if(profile.length===0) profile.push("first-timer");

  // Parse price range from hotel string e.g. "$80–$200/night" → max price
  const getMaxPrice = (h) => {
    const match = h.price.match(/\$(\d+)\/night/g);
    if(!match) return 999;
    const prices = match.map(m=>parseInt(m.replace(/\$|\/night/g,"")));
    return Math.min(...prices);
  };

  let filtered = HOTELS.filter(h=>h.profiles.some(p=>profile.includes(p)));

  // Apply specific hotelPref filters
  if(ans.hotelPref==="nosmoking") filtered = HOTELS.filter(h=>h.nosmoking);
  else if(ans.hotelPref==="kitchen") filtered = HOTELS.filter(h=>h.kitchen);
  else if(ans.hotelPref==="luxury" && budgetLimit>=300) filtered = HOTELS.filter(h=>h.stars>=5);
  else if(ans.hotelPref==="price" || ans.budget==="budget") filtered = HOTELS.filter(h=>h.stars<=3);
  else if(ans.hotelPref==="quiet") filtered = HOTELS.filter(h=>h.nosmoking||h.name.includes("Vdara")||h.name.includes("Park MGM")||h.name.includes("Signature")||h.name.includes("Trump"));
  else if(ans.hotelPref==="location") {
    // Strip Location — prioritize central Strip hotels within budget
    filtered = HOTELS.filter(h=>h.profiles.some(p=>profile.includes(p)));
    // Filter by budget
    if(budgetLimit<=150) filtered = filtered.filter(h=>getMaxPrice(h)<=budgetLimit+50);
  }

  // Always apply budget filter as soft filter — prefer hotels within budget
  const withinBudget = filtered.filter(h=>getMaxPrice(h)<=budgetLimit+50);
  ...
  // Fill if needed from all hotels within budget
  if(result.length<3) {
...
export default function VegasApp() {
  ...
  async function handleNext(){
    ...
    if(step<totalSteps){
      ...
      const skipVibe = !isGuysNow && newAns.tripType !== "family";
    ...
    const freeResults = FREE_EXPERIENCES.filter(f => {
      ...
      // Bellagio dedup — never show Fountains AND Conservatory together
          ...
          <div style={{animation:"fadeUp .5s ease"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:"20px",marginBottom:"28px"}}>
              {(() => {
                const combined = [];
                let freeIdx = 0;
                // Group into days — pairs of day+night
                ...
                for(let d=0; d<dayPairs; d++){
                  ...
                  combined.push(
                    <div key={`day-${d+1}`}>
                      ...
                      {/* Intercalate free every 2 days */}
                      {(d+1) % 2 === 0 && freeIdx < freeExp.length && (() => {
                        const f = freeExp[freeIdx++];
                        return <div style={{marginTop:"10px"}}><ExperienceCard key={f.id} exp={f} day={null} index={freeIdx} isFree={true}/></div>;
                      })()}
                    </div>
                  );
                }
                // Add remaining free
                while(freeIdx < freeExp.length){
                  const f = freeExp[freeIdx++];
                  combined.push(<ExperienceCard key={f.id} exp={f} day={null} index={freeIdx} isFree={true}/>);
                }
                return combined;
              })()}
            </div>
