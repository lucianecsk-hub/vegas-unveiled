...
const PAID = [
  ...
  { id:16, name:"All Shook Up — Elvis Show", cat:"Show", price:45, rating:4.8, reviews:1340, dur:"1.5 hrs", emoji:"🎸", desc:"Open bar cabin above the Strip. Premium experience, best views in Vegas.", url:"https://www.getyourguide.com/las-vegas-l58/las-vegas-all-shook-up-the-ultimate-elvis-tribute-t693302/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["solo","couple","group"], vibes:["luxury","romantic"], times:["night"], seasons:["winter","spring","summer","fall"], interests:["show"], tier:"budget" },
  ...
  { id:41, name:"Mt. Charleston Day Trip", cat:"Tour", price:109, rating:4.7, reviews:82, dur:"Half day", emoji:"❄️", desc:"30 minutes from the Strip. Hotel pickup included. Snow in winter, pine forests in spring.", url:"https://www.getyourguide.com/las-vegas-l58/las-vegas-mount-charleston-and-lee-canyon-day-trip-t371990/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["solo","couple","group","work"], vibes:[], times:["morning","day"], seasons:["winter"], interests:["adventure","unique"], tier:"mid" },
  ...
  { id:59, name:"KÀ Royal VIP + Backstage", cat:"Show", price:370, rating:5.0, reviews:1, dur:"3 hrs", emoji:"🎪", desc:"Cirque's most spectacular show — plus backstage access, artist meet and greet, VIP lounge.", url:"https://www.getyourguide.com/las-vegas-l58/las-vegas-ka-by-cirque-du-soleil-at-mgm-grand-ticket-t405483/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["couple"], vibes:["luxury","romantic"], times:["night"], seasons:["winter","spring","summer","fall"], interests:["show"], tier:"luxury" },
  ...
  { id:70, name:"Faaabulous! Ultimate Drag Brunch", cat:"Show", price:75, rating:4.9, reviews:150, dur:"2 hrs", emoji:"👑", desc:"The most spectacular drag brunch in Vegas. Lip sync battles, comedy, audience moments.", url:"https://vegas.vdvm.net/Gb06Em", provider:"VCO", tags:["solo","group"], vibes:["adventure"], times:["morning"], seasons:["spring"], interests:["show"], tier:"mid", lgbtq:true },
  { id:71, name:"Drag Brunch Las Vegas", cat:"Show", price:65, rating:4.8, reviews:120, dur:"2 hrs", emoji:"💅", desc:"Bottomless mimosas, drag queens, and the most fun brunch you've ever had.", url:"https://vegas.vdvm.net/n4ROgA", provider:"VCO", tags:["solo","couple","group"], vibes:["dark"], times:["morning","day"], seasons:["winter","spring","summer","fall"], interests:["show"], tier:"mid", lgbtq:true },
  { id:72, name:"RuPaul's Drag Race LIVE!", cat:"Show", price:99, rating:4.9, reviews:800, dur:"1.5 hrs", emoji:"🏆", desc:"The queens from RuPaul's Drag Race, live on the Vegas Strip. Iconic. Unmissable.", url:"https://vegas.vdvm.net/QYNqGY", provider:"VCO", tags:["solo","couple","group"], vibes:[], times:["night"], seasons:["winter","spring","summer","fall"], interests:["show"], tier:"mid", lgbtq:true },
  { id:73, name:"Drag Your Sass to Brunch", cat:"Show", price:55, rating:4.8, reviews:90, dur:"2 hrs", emoji:"🍔", desc:"Hamburger Mary's legendary drag brunch. Outrageous, hilarious, and inclusive.", url:"https://vegas.vdvm.net/B5zWG9", provider:"VCO", tags:["solo","couple","group"], vibes:[], times:["morning","day"], seasons:["winter","spring","summer","fall"], interests:["show"], tier:"budget", lgbtq:true },
  { id:74, name:"Strip Club Crawl + Open Bar + Party Bus", cat:"Nightlife", price:99, rating:4.7, reviews:150, dur:"4 hrs", emoji:"🍾", desc:"Party bus, open bar and VIP entry to Vegas' top strip clubs.", url:"https://www.getyourguide.com/las-vegas-l58/strip-club-crawl-open-bar-party-bus-t442598/?partner_id=FIT427X&utm_medium=online_publisher", provider:"GYG", tags:["solo","couple","group"], vibes:["luxury"], times:["night"], seasons:["winter","spring","summer","fall"], interests:["nightlife"], tier:"mid", guysTrip:true },
  { id:75, name:"Circa Las Vegas Sportsbook", cat:"Sports", price:0, rating:4.9, reviews:300, dur:"Any time", emoji:"🏆", desc:"The largest sportsbook in the world. 4 stories, 350 screens, stadium seating.", url:"https://vegas.vdvm.net/jRnEoP", provider:"VCO", tags:["solo","couple","group"], vibes:[], times:["day","night"], seasons:["winter","spring","summer","fall"], interests:["sports","unique"], tier:"budget", guysTrip:true },
  { id:76, name:"MGM Grand Race & Sports Book", cat:"Sports", price:0, rating:4.7, reviews:200, dur:"Any time", emoji:"🎰", desc:"One of Vegas' most iconic sportsbooks. Inside MGM Grand. Great screens, great action.", url:"https://vegas.vdvm.net/vD4LLv", provider:"VCO", tags:["solo","group","bachelorette"], vibes:["dark"], times:["day","night"], seasons:["winter","spring","summer","fall"], interests:["sports","unique"], tier:"budget", guysTrip:true },
  ...
  { id:79, name:"Las Vegas Aviators — Baseball Game", cat:"Sports", price:20, rating:4.7, reviews:150, dur:"3 hrs", emoji:"⚾", desc:"Triple-A baseball at Las Vegas Ballpark. Affordable, fun for all ages.", url:"https://vegas.vdvm.net/PzrLLe", provider:"VCO", tags:["solo","couple","group","family","work"], vibes:["adventure"], times:["day","night"], seasons:["winter","spring","fall"], interests:["sports"], tier:"budget" },
  { id:80, name:"Henderson Silver Knights — Hockey", cat:"Sports", price:25, rating:4.7, reviews:100, dur:"2.5 hrs", emoji:"🥅", desc:"The VGK's farm team. Dollar Arena in Henderson. Great hockey, small venue, affordable.", url:"https://vegas.vdvm.net/L0xvJM", provider:"VCO", tags:["solo","couple","group","family","kids"], vibes:["adventure"], times:["day","night"], seasons:["spring","summer"], interests:["sports"], tier:"budget", guysTrip:true },
  ...
  { id:83, name:"NBA Summer League", cat:"Sports", price:30, rating:4.7, reviews:150, dur:"2.5 hrs", emoji:"🏀", desc:"Watch NBA rookies and future stars before they make it big.", url:"https://vegas.vdvm.net/B5zj5B", provider:"VCO", tags:["solo","couple","group"], vibes:["luxury"], times:["day","night"], seasons:["fall"], interests:["sports"], tier:"budget", limitedTime:"Until Jul 19" },
  { id:84, name:"NASCAR Cup Series Las Vegas", cat:"Sports", price:75, rating:4.8, reviews:200, dur:"Full day", emoji:"🏁", desc:"500 miles of pure adrenaline at Las Vegas Motor Speedway.", url:"https://vegas.vdvm.net/6kPvkQ", provider:"VCO", tags:["solo","couple","group"], vibes:[], times:["morning","day"], seasons:["fall"], interests:["sports","adventure"], tier:"mid", guysTrip:true, limitedTime:"Until Oct 4" },
  { id:85, name:"Formula 1 Las Vegas Grand Prix", cat:"Sports", price:500, rating:4.9, reviews:300, dur:"Full day", emoji:"🏎️", desc:"F1 racing on the Las Vegas Strip at night. The most spectacular sporting event in the world.", url:"https://vegas.vdvm.net/dy9xyW", provider:"VCO", tags:["group","family","kids"], vibes:["adventure"], times:["day","night"], seasons:["summer"], interests:["sports","adventure"], tier:"luxury", guysTrip:true, limitedTime:"Until Nov 21" },
  { id:86, name:"BTS — Live in Las Vegas", cat:"Concert", price:101, rating:4.9, reviews:200, dur:"2.5 hrs", emoji:"💜", desc:"BTS live at Allegiant Stadium. Shows May 23, 24, 27 & 28. The biggest K-pop event of the year.", url:"https://vegas.vdvm.net/m4XeGa", provider:"VCO", tags:["solo","group","family"], vibes:["adventure"], times:["night"], seasons:["fall"], interests:["show"], tier:"mid", girlsTrip:true, lgbtq:true, limitedTime:"May 23–28, 2026" },
  { id:87, name:"Cowabunga Canyon Water Park", cat:"Adventure", price:45, rating:4.7, reviews:300, dur:"Full day", emoji:"💦", desc:"Vegas' best water park. Slides, lazy river, wave pool — the perfect summer day.", url:"https://vegas.vdvm.net/xkWeD1", provider:"VCO", tags:["solo","couple","group","family","kids"], vibes:[], times:["morning","day"], seasons:["summer"], interests:["adventure","unique"], tier:"budget" },
  ...
  { id:89, name:"Ed Sheeran — Allegiant Stadium", cat:"Concert", price:87, rating:4.8, reviews:50, dur:"2.5 hrs", emoji:"🎸", desc:"Ed Sheeran live at Allegiant Stadium. One of the biggest touring artists in the world.", url:"https://vegas.vdvm.net/k4aYxL", provider:"VCO", tags:["solo","couple","group","work"], vibes:["luxury","adventure"], times:["night"], seasons:["fall"], interests:["show"], tier:"mid", girlsTrip:true, limitedTime:"Until Jul 17" },
...
const FREE_EXPERIENCES = [
  ...
  { id:"f5", name:"Grand Canal Shoppes — The Venetian", loc:"The Venetian", time:"Anytime", emoji:"🛶", desc:"Venice reconstructed inside a hotel. Walk it for free. Watch the gondolas for free.", url:"https://vegas.vdvm.net/MmJJG3" },
  ...
  { id:"f4", name:"Flamingo Wildlife Habitat", loc:"Flamingo Hotel", time:"Morning", emoji:"🦩", desc:"Real flamingos living inside a casino resort. Free to visit. Great for families and kids.", tags:["family","kids"], url:"https://vegas.vdvm.net/6eOKEq" },
...
const HOTELS = [
  ...
  { name:"Mandalay Bay", stars:4, price:"$120–$350/night", feature:"Beach pool, lazy river", url:"https://vegas.vdvm.net/WqmQxO", profiles:["couple","girls","family","work"], tiers:["mid","high"], location:"north-south", nosmoking:false, kitchen:false },
...
const QUESTIONS = [
  ...
  { id:"season", question:"When are you visiting?", subtitle:"Vegas transforms completely with each season", cols:2, multi:false,
    options:[
      {v:"winter",label:"Winter",emoji:"❄️",desc:"Dec – Feb · 35°F–57°F · Cool nights, Mt. Charleston snow"},
      {v:"spring",label:"Spring",emoji:"🌸",desc:"Mar – May · 50°F–82°F · Perfect weather"},
      {v:"summer",label:"Summer",emoji:"☀️",desc:"Jun – Sep · 77°F–108°F · Extreme heat, pool parties"},
      {v:"fall",label:"Fall",emoji:"🍂",desc:"Oct – Nov · 46°F–77°F · Golden weather"},
    ]},
...
function getMaxCards(days){return{["1-2"]:6,["3-4"]:8,["5-7"]:14,["1week"]:16}[days]||8;}
...
function filterExperiences(ans){
  ...
  const KIDS6_IDS=[5,23,4,7,10,25,38,17,26];
  const TEENS_IDS=[5,38,1,47,42,40,4,21,23,19,43];
  ...
  const scored=PAID.map(exp=>{
    ...
    vibes.forEach(v=>{
      ...
      else if(v==="casino"){if(exp.interests?.includes("sports")||SPORTS_IDS.includes(exp.id))s+=4;if(exp.vibes?.includes("casino"))s+=4;}
    ...
    interests.forEach(i=>{if(exp.interests&&exp.interests.includes(i))s+=3;if(exp.tags.includes(i))s+=2;});
    ...
    if(budgetMatch(exp.price))s+=3;else s-=2;
  ...
  const dayScored=scored.filter(e=>(e.times.includes("morning")||e.times.includes("day"))&&budgetMatch(e.price));
  const nightScored=scored.filter(e=>e.times.includes("night")&&budgetMatch(e.price));
...
function getHotels(ans){
  ...
  const seen=new Set();const result=[];let hasMGM=false;
  ...
  if(result.length<3){
    ...
    for(const h of HOTELS){
      if(!seen.has(h.name)&&result.length<3&&h.profiles.some(p=>profile.includes(p))&&h.tiers.some(t=>allowedTiers.includes(t))){seen.add(h.name);result.push(h);}
    }
  }
  return result;
}
...
export default function VegasApp(){
  ...
  async function handleNext(){
    ...
    setAnswers(newAns);setSelected(null);
    if(step<totalSteps){
      ...
      if(nextQ?.id==="hotelPref"&&newAns.alreadyInVegas==="already"){const finalAns={...newAns,hotelPref:"location"};setAnswers(finalAns);setStep(nextStep+1);return;}
      ...
      if(nextQ?.id==="interest"&&newAns.tripType==="family"){
        ...
        setAnswers(finalAns);setStep(nextStep+1);
    ...
    setItinerary(results);setFreeExp(freeResults);setHotels(hotelResults);
    setAiStory("You arrive in Vegas already knowing what you want — and the city's about to confirm every instinct. Your itinerary is ready.");
    setLoading(false);setStep(totalSteps+1);
    ...
    const vibeLabels={dark:"drawn to the dark and mysterious side of Vegas",luxury:"a pure luxury seeker",adventure:"a thrill seeker",casino:"a casino and sports lover",romantic:"a hopeless romantic","first-timer":"experiencing Vegas for the first time",girlswild:"ready for a wild night out",girlsspa:"craving luxury and relaxation",girlsadventure:"an adventure-loving traveler",girlsmix:"looking for a perfect mix",thrill:"craving thrills and adventure",show:"a live entertainment lover",explore:"an explorer at heart",relaxed:"looking for easy fun",nightout:"here for the nightlife"};
    const budgetDesc={budget:"looks for the best experience at the lowest cost",mid:"balances spending consciously",high:"travels comfortably without overthinking costs",vip:"cost is never the deciding factor — only the best"}[newAns.budget]||"";
    const genderPrefix=genderLabels[newAns.groupGender]||"";
    const travelerType=genderPrefix?`${genderPrefix} ${tripLabels[newAns.tripType]||""}`.trim():tripLabels[newAns.tripType]||"traveler";
    ...
    fetch("/api/briefing",{method:"POST",headers:{"Content-Type":"application/json"},
  ...
  return(
    <div style={{minHeight:"100vh",background:"linear-gradient(160deg,#080810 0%,#0d0a18 45%,#080810 100%)",fontFamily:"'DM Sans','Georgia',sans-serif",color:"#fff",overflow:"hidden",position:"relative"}}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,400&family=DM+Sans:wght@300;400;600;700&display=swap');
      ...
      `}</style>
      {[...Array(25)].map((_,i)=>(
        <div key={i} style={{position:"fixed",borderRadius:"50%",pointerEvents:"none",width:`${(i%3)+1}px`,height:`${(i%3)+1}px`,background:["#ffd700","#ff2d55","#9b59b6","#3498db"][i%4],left:`${(i*4.1)%100}%`,top:`${(i*7.3)%100}%`,animation:`pulse ${2+(i%4)}s ease-in-out infinite`,animationDelay:`${i*0.2}s`}}/>
      ))}
      <div style={{maxWidth:"680px",margin:"0 auto",padding:"28px 18px",position:"relative"}}>
        <div style={{textAlign:"center",marginBottom:"36px",animation:"fadeUp .6s ease"}}>
          <div style={{fontSize:"0.6rem",letterSpacing:"0.5em",color:"#ff2d55",marginBottom:"10px",textTransform:"uppercase",fontFamily:"'DM Sans',sans-serif"}}>◆ CLASSIFIED ◆</div>
          <h1 style={{fontSize:"clamp(1.8rem,6vw,3rem)",margin:"0 0 6px",fontFamily:"'Playfair Display',serif",background:"linear-gradient(135deg,#ffd700 0%,#ff2d55 50%,#ffd700 100%)",backgroundSize:"200% auto",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",animation:"flicker 9s infinite, shimmer 4s linear infinite",lineHeight:1.1}}>VEGAS UNVEILED</h1>
          <p style={{color:"#aaa",fontSize:"0.85rem",margin:0,letterSpacing:"0.1em",fontFamily:"'DM Sans',sans-serif"}}>Experiences they don't put in the brochures</p>
        </div>
        ...
        {step===0&&(
          <div style={{animation:"fadeUp .6s ease .2s both"}}>
            <div style={{background:"linear-gradient(135deg,rgba(255,45,85,.07),rgba(255,215,0,.04))",border:"1px solid rgba(255,215,0,.12)",borderRadius:"20px",padding:"40px 28px",textAlign:"center",marginBottom:"24px"}}>
              ...
              <h2 style={{fontSize:"1.45rem",color:"#fff",margin:"0 0 18px",fontFamily:"'Playfair Display',serif",fontWeight:700,lineHeight:1.35}}>There's a side of Vegas <em style={{color:"#ff2d55",fontStyle:"italic"}}>most people never find.</em></h2>
              <p style={{color:"#ccc",lineHeight:1.85,margin:"0 0 10px",fontSize:"0.95rem",fontFamily:"'DM Sans',sans-serif"}}>Answer a few questions and we'll reveal your personal traveler profile — then build you an itinerary as unique as you are.</p>
              <p style={{color:"#999",fontSize:"0.85rem",margin:0,fontStyle:"italic",fontFamily:"'DM Sans',sans-serif"}}>Quick, personal, free.</p>
            </div>
            <button onClick={handleNext} style={{width:"100%",padding:"19px",borderRadius:"12px",border:"none",background:"linear-gradient(135deg,#ff2d55,#ff6b35)",color:"#fff",fontSize:"0.95rem",fontWeight:"700",cursor:"pointer",letterSpacing:"0.08em",textTransform:"uppercase",boxShadow:"0 8px 32px rgba(255,45,85,.38)",transition:"all .2s",fontFamily:"'DM Sans',sans-serif"}}
            ...
            <p style={{textAlign:"center",color:"#aaa",fontSize:"0.82rem",margin:"12px 0 0",fontStyle:"italic",fontFamily:"'DM Sans',sans-serif"}}>✨ Includes free hidden gems only locals know</p>
          </div>
        )}
          ...
          <div key={step} style={{animation:"fadeUp .35s ease"}}>
            ...
            {currentQ.multi&&(
              <div style={{background:"rgba(255,215,0,.12)",border:"2px solid rgba(255,215,0,.5)",borderRadius:"10px",padding:"12px 16px",marginBottom:"14px",display:"flex",alignItems:"center",gap:"10px"}}>
                ...
                <span style={{color:"#ffd700",fontSize:"0.95rem",fontWeight:"700",fontFamily:"'DM Sans',sans-serif"}}>
              ...
              {currentQ.options.map(opt=>{
                ...
                return(
                  <button key={opt.v} onClick={()=>!isDisabled&&handleSelect(opt.v)} style={{padding:"16px 12px",borderRadius:"13px",border:"none",cursor:isDisabled?"not-allowed":"pointer",
                    ...
                    opacity:isDisabled&&!isSel?.45:1,color:"#fff",textAlign:"left",transition:"all .2s",transform:isSel?"scale(1.03)":"scale(1)"}}>
                    <div style={{fontSize:"1.4rem",marginBottom:"6px"}}>{opt.emoji}</div>
                    <div style={{fontWeight:"700",fontSize:"0.95rem",marginBottom:"4px",color:isSel?"#ffd700":"#fff",fontFamily:"'DM Sans',sans-serif"}}>{opt.label}</div>
                    <div style={{color:"#aaa",fontSize:"0.8rem",lineHeight:1.5,fontFamily:"'DM Sans',sans-serif"}}>{opt.desc}</div>
            ...
            <div style={{position:"sticky",bottom:"16px",zIndex:100,marginTop:"16px"}}>
              <button onClick={handleNext} disabled={!canContinue} style={{width:"100%",padding:"16px",borderRadius:"12px",border:"none",
                ...
                boxShadow:canContinue?"0 6px 24px rgba(255,45,85,.5)":"0 2px 8px rgba(0,0,0,.6)",
                border:canContinue?"none":"1px solid rgba(255,255,255,.08)",fontFamily:"'DM Sans',sans-serif"}}>
        ...
        {loading&&(
          <div style={{textAlign:"center",padding:"60px 0",animation:"fadeUp .4s ease"}}>
            <div style={{position:"relative",width:"70px",height:"70px",margin:"0 auto 24px"}}>
              {[0,1,2].map(i=>(<div key={i} style={{position:"absolute",inset:`${i*8}px`,borderRadius:"50%",border:"2px solid transparent",borderTopColor:i%2===0?"#ff2d55":"#ffd700",animation:`spin ${1+i*.5}s linear infinite ${i%2?"reverse":""}`}}/>))}
            </div>
            <p style={{color:"#ffd700",fontSize:"0.95rem",margin:"0 0 6px",fontFamily:"'DM Sans',sans-serif"}}>Accessing the underground...</p>
            <p style={{color:"#888",fontSize:"0.78rem",fontFamily:"'DM Sans',sans-serif"}}>Building your secret Vegas itinerary</p>
          </div>
        )}
          ...
          <div style={{animation:"fadeUp .5s ease"}}>
              ...
              {!aiReady?(
                <div style={{display:"flex",alignItems:"center",gap:"12px",padding:"8px 0"}}>
                  <div style={{position:"relative",width:"28px",height:"28px",flexShrink:0}}>
                    {[0,1,2].map(i=>(<div key={i} style={{position:"absolute",inset:`${i*4}px`,borderRadius:"50%",border:"1.5px solid transparent",borderTopColor:i%2===0?"#ff2d55":"#ffd700",animation:`spin ${0.8+i*.3}s linear infinite ${i%2?"reverse":""}`}}/>))}
                  </div>
                  <div>
                    <p style={{color:"#ffd700",fontSize:"0.8rem",margin:"0 0 3px",fontWeight:"700",fontFamily:"'DM Sans',sans-serif"}}>Analyzing your traveler profile...</p>
                    <p style={{color:"#888",fontSize:"0.72rem",margin:0,fontFamily:"'DM Sans',sans-serif"}}>Your personalized briefing will appear in a few seconds ✨</p>
                  </div>
                </div>
              ):(
                <div style={{animation:"fadeUp .5s ease"}}>
                  {aiTitle&&(
                    <div style={{marginBottom:"14px"}}>
                      <span style={{fontSize:"0.75rem",letterSpacing:"0.18em",color:"#ff2d55",textTransform:"uppercase",fontFamily:"'DM Sans',sans-serif",fontWeight:"700"}}>Traveler Profile</span>
                      <div style={{fontSize:"1.08rem",fontWeight:"700",color:"#ffd700",fontFamily:"'Playfair Display',serif",marginTop:"4px"}}>{aiTitle}</div>
                    </div>
                  )}
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:"6px",marginBottom:"22px"}}>
              {[`${seasonLabels[answers.season]} in Vegas`,`${daysLabels[answers.days]} trip`].map(b=>(
                <div key={b} style={{background:"rgba(255,215,0,.07)",border:"1px solid rgba(255,215,0,.16)",borderRadius:"20px",padding:"4px 14px",color:"#ffd700",fontSize:"0.72rem",letterSpacing:"0.06em",fontFamily:"'DM Sans',sans-serif"}}>{b}</div>
              ))}
            </div>

            {hotels.length>0&&answers.alreadyInVegas!=="already"&&(
              <div style={{marginBottom:"28px"}}>
                <h3 style={{color:"#fff",fontSize:"1.1rem",margin:"0 0 4px",fontWeight:"700",fontFamily:"'Playfair Display',serif"}}>🏨 Where to Stay</h3>
                <p style={{color:"#888",fontSize:"0.78rem",margin:"0 0 14px",fontFamily:"'DM Sans',sans-serif"}}>Matched to your profile & budget</p>
                  ...
                  {hotels.map((h,i)=>(
                    <div key={h.name} style={{background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.09)",borderRadius:"14px",padding:"18px",animation:`fadeUp .5s ease ${i*.1}s both`}}>
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"10px"}}>
                        <div style={{flex:1}}>
                          <div style={{color:"#fff",fontWeight:"700",fontSize:"1rem",marginBottom:"3px",fontFamily:"'DM Sans',sans-serif"}}>{h.name}</div>
                          <div style={{color:"#ffd700",fontSize:"0.75rem",marginBottom:"5px"}}>{"⭐".repeat(h.stars)}</div>
                          <div style={{color:"#aaa",fontSize:"0.82rem",fontFamily:"'DM Sans',sans-serif"}}>{h.feature}</div>
                        </div>
                        <div style={{color:"#2ecc71",fontSize:"0.85rem",fontWeight:"700",marginLeft:"12px",whiteSpace:"nowrap",fontFamily:"'DM Sans',sans-serif"}}>{h.price}</div>
                      </div>
                      <a href={h.url} target="_blank" rel="noopener noreferrer" style={{display:"block",background:"rgba(26,92,26,.5)",border:"1px solid rgba(39,174,96,.4)",color:"#2ecc71",padding:"12px 16px",borderRadius:"9px",textDecoration:"none",fontSize:"0.85rem",fontWeight:"700",textAlign:"center",fontFamily:"'DM Sans',sans-serif"}}>🏨 View Hotel</a>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <h2 style={{color:"#fff",fontSize:"1.2rem",margin:"0 0 4px",fontFamily:"'Playfair Display',serif",fontWeight:700}}>Your Itinerary</h2>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:"20px",marginBottom:"28px"}}>
              {(()=>{
                ...
                for(let d=0;d<dayPairs;d++){
                  ...
                  combined.push(
                    <div key={`day-${d+1}`}>
                      <div style={{color:"#ff2d55",fontSize:"1.1rem",fontWeight:"700",letterSpacing:"0.05em",margin:"0 0 8px",fontFamily:"'Playfair Display',serif"}}>Day {d+1}</div>
                      <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
                        {dayExp&&<ExperienceCard key={dayExp.id} exp={dayExp} index={d*2} isFree={false} timeLabel="🌅 Day"/>}
                        {freeForThisDay&&<ExperienceCard key={freeForThisDay.id} exp={freeForThisDay} index={d*2} isFree={true}/>}
                        {nightExp&&<ExperienceCard key={nightExp.id} exp={nightExp} index={d*2+1} isFree={false} timeLabel="🌙 Night"/>}
                      </div>
                    </div>
                  );
                }
            ...
            {answers.tripType==="family"&&(
              <div style={{background:"rgba(255,215,0,.05)",border:"1px solid rgba(255,215,0,.15)",borderRadius:"16px",padding:"20px",marginBottom:"22px"}}>
                <div style={{color:"#ffd700",fontSize:"0.62rem",letterSpacing:"0.2em",marginBottom:"12px",fontFamily:"'DM Sans',sans-serif"}}>◆ INSIDER TIPS — VEGAS WITH KIDS</div>
                <div style={{display:"flex",flexDirection:"column",gap:"8px"}}>
                  {[
                    ...
                    {emoji:"🎰",tip:"Kids can walk through casinos but cannot stop, sit or linger — even with an adult."},
                    ...
                    <div key={i} style={{display:"flex",gap:"10px",alignItems:"flex-start"}}>
                      ...
                      <p style={{color:"#aaa",fontSize:"0.78rem",lineHeight:1.6,margin:0,fontFamily:"'DM Sans',sans-serif"}}>{item.tip}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{marginBottom:"20px"}}>
              <p style={{color:"#aaa",fontSize:"0.78rem",margin:"0 0 10px",textAlign:"center",fontFamily:"'DM Sans',sans-serif"}}>Know someone who'd love this? Send them their own custom itinerary.</p>
              <div style={{display:"flex",gap:"8px"}}>
                <button onClick={()=>{const t="Going to Vegas? Discover your traveler profile 🎰\n"+window.location.href;if(navigator.clipboard?.writeText){navigator.clipboard.writeText(t).then(()=>alert("Copied! Just paste and send 🎰")).catch(()=>prompt("Copy this:",t));}else{prompt("Copy this:",t);}}} style={{flex:1,padding:"12px",borderRadius:"9px",border:"1px solid rgba(255,255,255,.12)",background:"rgba(255,255,255,.05)",color:"#ccc",fontSize:"0.8rem",cursor:"pointer",fontFamily:"'DM Sans',sans-serif"}}>🔗 Copy Link</button>
                <button onClick={()=>{const t="Going to Vegas? Discover your traveler profile 🎰";if(navigator.share){navigator.share({title:"Vegas Unveiled",text:t,url:window.location.href});}else{prompt("Copy and share:",t+"\n"+window.location.href);}}} style={{flex:1,padding:"12px",borderRadius:"9px",border:"1px solid rgba(255,215,0,.25)",background:"rgba(255,215,0,.08)",color:"#ffd700",fontSize:"0.8rem",cursor:"pointer",fontWeight:"700",fontFamily:"'DM Sans',sans-serif"}}>💬 Share with Friends</button>
              </div>
            </div>
            ...
            <div style={{background:"rgba(255,215,0,.04)",border:"1px solid rgba(255,215,0,.12)",borderRadius:"14px",padding:"18px",marginBottom:"16px",textAlign:"center"}}>
              <p style={{color:"#ccc",fontSize:"0.85rem",margin:"0 0 4px",fontWeight:"700",fontFamily:"'DM Sans',sans-serif"}}>🎰 Missing something in your itinerary?</p>
              <p style={{color:"#888",fontSize:"0.78rem",margin:"0 0 12px",fontFamily:"'DM Sans',sans-serif"}}>Vegas is waiting for you with open arms.</p>
              <a href="mailto:unveiledvegas@gmail.com?subject=Itinerary Feedback" style={{display:"inline-block",padding:"10px 22px",borderRadius:"9px",border:"1px solid rgba(255,215,0,.25)",color:"#ffd700",fontSize:"0.8rem",textDecoration:"none",fontWeight:"700",fontFamily:"'DM Sans',sans-serif"}}>Leave Your Feedback →</a>
            </div>

            <button onClick={()=>{setStep(0);setAnswers({});setSelected(null);setAiStory("");setAiTitle("");setAiReady(false);setItinerary([]);setFreeExp([]);setHotels([]);}}
              style={{width:"100%",padding:"16px",borderRadius:"10px",background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.2)",color:"#bbb",fontSize:"0.95rem",fontWeight:"600",cursor:"pointer",transition:"all .2s",fontFamily:"'DM Sans',sans-serif"}}
            ...
            <p style={{textAlign:"center",color:"#444",fontSize:"0.65rem",marginTop:"16px",fontFamily:"'DM Sans',sans-serif"}}>Booking links may include affiliate partnerships · Prices subject to availability</p>
          </div>
        )}
      </div>
    </div>
...
function ExperienceCard({exp,index,isFree,timeLabel}){
  ...
  return(
    <div onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      style={{background:hov?`linear-gradient(135deg,${isFree?"rgba(39,174,96,.1)":"rgba(255,45,85,.1)"},rgba(255,215,0,.05))`:"rgba(255,255,255,.04)",
        border:hov?`1px solid ${isFree?"rgba(39,174,96,.3)":"rgba(255,215,0,.3)"}`:"1px solid rgba(255,255,255,.08)",
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"10px"}}>
        <div style={{display:"flex",gap:"12px",alignItems:"flex-start",flex:1}}>
          <div style={{minWidth:"44px",textAlign:"center"}}><span style={{fontSize:"1.8rem"}}>{exp.emoji}</span></div>
          <div style={{flex:1}}>
            <div style={{color:"#fff",fontWeight:"700",fontSize:"1rem",marginBottom:"6px",lineHeight:1.3,fontFamily:"'DM Sans',sans-serif"}}>{exp.name}</div>
            <div style={{display:"flex",gap:"5px",flexWrap:"wrap"}}>
              {!isFree&&timeLabel&&<span style={{background:"rgba(255,45,85,.12)",color:"#ff6b8a",fontSize:"0.72rem",padding:"2px 10px",borderRadius:"20px",border:"1px solid rgba(255,45,85,.2)",fontFamily:"'DM Sans',sans-serif"}}>{timeLabel}</span>}
              {exp.dur&&<span style={{background:"rgba(255,215,0,.15)",color:"#ffd700",fontSize:"0.72rem",padding:"2px 10px",borderRadius:"20px",border:"1px solid rgba(255,215,0,.25)",fontFamily:"'DM Sans',sans-serif"}}>{exp.dur}</span>}
              {exp.rating>0&&<span style={{background:"rgba(255,45,85,.15)",color:"#ff8080",fontSize:"0.72rem",padding:"2px 10px",borderRadius:"20px",border:"1px solid rgba(255,45,85,.25)",fontFamily:"'DM Sans',sans-serif"}}>⭐ {exp.rating}</span>}
              {exp.isNew&&<span style={{background:"rgba(39,174,96,.2)",color:"#2ecc71",fontSize:"0.72rem",padding:"2px 10px",borderRadius:"20px",border:"1px solid rgba(39,174,96,.3)",fontFamily:"'DM Sans',sans-serif"}}>✨ New</span>}
              {exp.limitedTime&&<span style={{background:"rgba(255,165,0,.15)",color:"#ffaa00",fontSize:"0.72rem",padding:"2px 10px",borderRadius:"20px",border:"1px solid rgba(255,165,0,.3)",fontFamily:"'DM Sans',sans-serif"}}>⏰ {exp.limitedTime}</span>}
            </div>
          </div>
        </div>
        {isFree
          ?<span style={{background:"rgba(39,174,96,.2)",border:"1px solid rgba(39,174,96,.4)",color:"#2ecc71",fontSize:"0.78rem",fontWeight:"700",padding:"4px 12px",borderRadius:"20px",whiteSpace:"nowrap",marginLeft:"8px",fontFamily:"'DM Sans',sans-serif"}}>FREE</span>
      ...
      <p style={{color:"#bbb",fontSize:"0.85rem",lineHeight:1.7,margin:"0 0 14px",fontFamily:"'DM Sans',sans-serif"}}>{exp.desc}</p>
      <a href={exp.url} target="_blank" rel="noopener noreferrer"
        style={{display:"block",background:isFree?"linear-gradient(135deg,rgba(39,174,96,.3),rgba(39,174,96,.15))":"linear-gradient(135deg,#ff2d55,#c0392b)",
          ...
          boxShadow:isFree?"none":"0 4px 18px rgba(255,45,85,.35)",fontFamily:"'DM Sans',sans-serif"}}>
